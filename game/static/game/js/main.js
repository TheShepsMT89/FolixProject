window.addEventListener("load", function () {
  ...
  speakerEl.classList.add("cursor-hover");
  speakerEl.setAttribute("id", "speaker");
  speakerEl.src =
    "https://cdn.discordapp.com/attachments/1166967099336425532/1182355612072411287/svgviewer-png-output.png?ex=65846579&is=6571f079&hm=1860ab96fc92275c05d5e0aada0bc44624e834b75711da5aeb297ced592b0f37&";
  ...
  const randomWordsCreator = () => {
    data.map((obj) => {
      splittedStr = obj.spaPhrase.split(" ");
  ...
  speakerEl.addEventListener("click", () => {
    speak(data[incr].engPhrase, "en-US");
  });
